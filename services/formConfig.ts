...
const accessDoorFields: Record<string, FormFieldConfig> = {
  ...
  door_contact: { label: 'Door Contact', icon: '🧲', type: 'boolean', visible: true },
  rex: { label: 'Request to Exit (REX)', icon: '🏃', type: 'boolean', visible: true },
  push_to_exit: { label: 'Push to Exit', icon: '🔘', type: 'boolean', visible: true },
  intercom_buzzer: { label: 'Intercom/Buzzer', icon: '🔊', type: 'boolean', visible: true },
  crash_bar: { label: 'Crash Bar', icon: '💥', type: 'boolean', visible: true },
